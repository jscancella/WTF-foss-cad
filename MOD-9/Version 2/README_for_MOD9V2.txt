MOD9V2: Modular Weight Forward Bolt 9mm Luger Semi-Auto Pistol Caliber Carbine (PCC) by Weight Forward & Gun CAD Ideas 3D printing firearms developement group
...
Files are offically hosted at https://odysee.com/@WTF-9:1/MOD9-v2:d
Offical backup is at https://lbry.tv/@WTF-9:1/MOD9-v2:d
...
README Version 1.0
README Date: April 21, 2021
Zip File Version 1.1
Zip File Date: April 21, 2021
...
******************Table of Contents:
  ...
  -Contact Info
  -What is the MOD9V2?
  -MOD9V2 Printed Parts List
  -MOD9V2 Non-Printed Parts List
  -MOD9V2 Non-Printed Parts for building with Brass Heat Set Inserts
  -Tools needed to build a MOD9V2
  -Recomended Filaments
  -3D print settings: for PLA/PLA+
   -on Cura Slicer
   -on PrusaSlicer
  -Assembly Notes
  -Assembly Notes for building with Brass Heat Set Inserts
  -Build Videos for the MOD9V2
  -Function Check
  -Trouble Shooting
  -FAQ
  -Changelog
...
*Fabricated Parts: Refer to the "Technical_Drawings_of_Bolt_&_Firing Pin" folder and "Intstructions_&_Guides" folder
  - Bolt - can be made using either of the 2 options below
...
- Firing Pin - can be made or use following any of the 4 options below
